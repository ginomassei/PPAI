...
public class CientificosVendor {
    ...
    public void crearPersonalCientifico() {
        PersonalCientifico cientifico1 = new PersonalCientifico(
            2901,
            "Pedro",
            "Sanchez",
            "20948277",
            ...
            null,
            null,
            usuariosVendor.getUsuarios().get(0)
        );

        PersonalCientifico cientifico2 = new PersonalCientifico(
            2923,
            "Maria",
            "Tretta",
            "24248567",
            ...
            null,
            null,
            usuariosVendor.getUsuarios().get(1)
        );

        PersonalCientifico cientifico3 = new PersonalCientifico(
            2832,
            "Gabriel",
            "Lazcano",
            "23229098",
            ...
            null,
            null,
            usuariosVendor.getUsuarios().get(2)
        );

        PersonalCientifico cientifico4 = new PersonalCientifico(
            2143,
            "Carlos",
            "Ruiz",
            "27525878",
            ...
            null,
            null,
            usuariosVendor.getUsuarios().get(3)
        );

        PersonalCientifico cientifico5 = new PersonalCientifico(
            3001,
            "Andrea",
            "Reynoso",
            "19610500",
            ...
            null,
            null,
            usuariosVendor.getUsuarios().get(4)
        );

        PersonalCientifico cientifico6 = new PersonalCientifico(
            2789,
            "Tomas",
            "Diaz",
            "21404747",
            ...
            null,
            null,
            usuariosVendor.getUsuarios().get(5)
        );
    ...
    public void crearAsignacionesCientificosCI() {
        ...
        AsignacionCientificoCI asignacion1 = new AsignacionCientificoCI(
            cientificos.get(0),
            fechaDesde1,
            null,
            null
        ...
        AsignacionCientificoCI asignacion2 = new AsignacionCientificoCI(
            cientificos.get(1),
            fechaDesde2,
            null,
            null);
        ...
        AsignacionCientificoCI asignacion3 = new AsignacionCientificoCI(
            cientificos.get(2),
            fechaDesde3,
            null,
            null
        ...
        AsignacionCientificoCI asignacion4 = new AsignacionCientificoCI(
            cientificos.get(3),
            fechaDesde4,
            null,
            null
        ...
        AsignacionCientificoCI asignacion5 = new AsignacionCientificoCI(
            cientificos.get(4),
            fechaDesde5,
            null,
            null
        ...
        AsignacionCientificoCI asignacion6 = new AsignacionCientificoCI(
            cientificos.get(5),
            fechaDesde6,
            null,
            null
